...
co.table1 <- rbind(
  get.stats(df=daily,metric="MDA1",region="all",season="all",digits=2),
  get.stats(df=daily,metric="MDA1",region="all",season="winter",digits=2),
  get.stats(df=daily,metric="MDA1",region="all",season="spring",digits=2),
  get.stats(df=daily,metric="MDA1",region="all",season="summer",digits=2),
  get.stats(df=daily,metric="MDA1",region="all",season="autumn",digits=2),
  get.stats(df=daily,metric="MDA8",region="all",season="all",digits=2),
  get.stats(df=daily,metric="MDA8",region="all",season="winter",digits=2),
  get.stats(df=daily,metric="MDA8",region="all",season="spring",digits=2),
  get.stats(df=daily,metric="MDA8",region="all",season="summer",digits=2),
  get.stats(df=daily,metric="MDA8",region="all",season="autumn",digits=2),
  get.stats(df=daily,metric="DA24",region="all",season="all",digits=2),
  get.stats(df=daily,metric="DA24",region="all",season="winter",digits=2),
  get.stats(df=daily,metric="DA24",region="all",season="spring",digits=2),
  get.stats(df=daily,metric="DA24",region="all",season="summer",digits=2),
  get.stats(df=daily,metric="DA24",region="all",season="autumn",digits=2))
...
co.table2 <- rbind(
  get.stats(df=daily,metric="MDA1",region="all",season="all",digits=2),
  get.stats(df=nroad,metric="MDA1",region="all",season="all",digits=2),
  get.stats(df=urban,metric="MDA1",region="all",season="all",digits=2),
  get.stats(df=rural,metric="MDA1",region="all",season="all",digits=2),
  get.stats(df=daily,metric="MDA8",region="all",season="all",digits=2),
  get.stats(df=nroad,metric="MDA8",region="all",season="all",digits=2),
  get.stats(df=urban,metric="MDA8",region="all",season="all",digits=2),
  get.stats(df=rural,metric="MDA8",region="all",season="all",digits=2),
  get.stats(df=daily,metric="DA24",region="all",season="all",digits=2),
  get.stats(df=nroad,metric="DA24",region="all",season="all",digits=2),
  get.stats(df=urban,metric="DA24",region="all",season="all",digits=2),
  get.stats(df=rural,metric="DA24",region="all",season="all",digits=2))
colnames(co.table2)[2] <- "site.type"; co.table2$max <- round(co.table2$max,1);
...
monitors <- rbind(pb.monitors[,-12],pb.nonreg.monitors)
...
pb.table2 <- rbind(
  get.stats(df=daily.tsp.so,metric="conc",region="all",season="all",digits=3),
  get.stats(df=daily.tsp.nso,metric="conc",region="all",season="all",digits=3),
  get.stats(df=daily.pm10,metric="conc",region="all",season="all",digits=3),
  get.stats(df=daily.pm25.urban,metric="conc",region="all",season="all",digits=3),
  get.stats(df=daily.pm25.rural,metric="conc",region="all",season="all",digits=3),
  get.stats(df=monthly.tsp.so,metric="conc",region="all",season="all",digits=3),
  get.stats(df=monthly.tsp.nso,metric="conc",region="all",season="all",digits=3),
  get.stats(df=monthly.pm10,metric="conc",region="all",season="all",digits=3),
  get.stats(df=monthly.pm25.urban,metric="conc",region="all",season="all",digits=3),
  get.stats(df=monthly.pm25.rural,metric="conc",region="all",season="all",digits=3),
  get.stats(df=monthly.tsp.so,metric="conc.3mo",region="all",season="all",digits=3),
  get.stats(df=monthly.tsp.nso,metric="conc.3mo",region="all",season="all",digits=3),
  get.stats(df=monthly.pm10,metric="conc.3mo",region="all",season="all",digits=3),
  get.stats(df=monthly.pm25.urban,metric="conc.3mo",region="all",season="all",digits=3),
  get.stats(df=monthly.pm25.rural,metric="conc.3mo",region="all",season="all",digits=3))
...
no2.table3 <- rbind(
  get.stats(df=daily,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=nroad,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=urban,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=rural,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=daily,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=nroad,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=urban,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=rural,metric="DA24",region="all",season="all",digits=1))
...
rural.east <- subset(daily.ws,site %in% sites$site[which(sites$network == "CASTNET" & sites$longitude > -100)])
urban.east <- subset(daily.ws,site %in% sites$site[which((grepl("NCORE",sites$network) | grepl("PAMS",sites$network)) &
   sites$measurement_scale != "Regional Scale" & sites$longitude > -100)])
rural.west <- subset(daily.ws,site %in% sites$site[which(sites$network == "CASTNET" & sites$longitude < -100)])
urban.west <- subset(daily.ws,site %in% sites$site[which((grepl("NCORE",sites$network) | grepl("PAMS",sites$network)) &
   sites$measurement_scale != "Regional Scale" & sites$longitude < -100)])
o3.table3 <- rbind(
  get.stats(df=daily.ws,metric="MDA1",region="all",season="all"),
  get.stats(df=urban.east,metric="MDA1",region="all",season="all"),
  get.stats(df=rural.east,metric="MDA1",region="all",season="all"),
  get.stats(df=urban.west,metric="MDA1",region="all",season="all"),
  get.stats(df=rural.west,metric="MDA1",region="all",season="all"),
  get.stats(df=daily.ws,metric="MDA8",region="all",season="all"),
  get.stats(df=urban.east,metric="MDA8",region="all",season="all"),
  get.stats(df=rural.east,metric="MDA8",region="all",season="all"),
  get.stats(df=urban.west,metric="MDA8",region="all",season="all"),
  get.stats(df=rural.west,metric="MDA8",region="all",season="all"),
  get.stats(df=daily.ws,metric="DA24",region="all",season="all"),
  get.stats(df=urban.east,metric="DA24",region="all",season="all"),
  get.stats(df=rural.east,metric="DA24",region="all",season="all"),
  get.stats(df=urban.west,metric="DA24",region="all",season="all"),
  get.stats(df=rural.west,metric="DA24",region="all",season="all"))
...
pm10.monitors <- pm10.monitors[,-c(grep("naa",colnames(pm10.monitors)))]
pm10.monitors <- rbind(pm10.monitors,pm10.nonreg.monitors)
pm10.monitors$site <- substr(pm10.monitors$id,1,9)
pm25.monitors <- pm25.monitors[,-c(grep("naa",colnames(pm25.monitors)))]
pm25.monitors <- rbind(pm25.monitors,pm25.nonreg.monitors)
...
pm10.urban.east <- subset(pm10.mean,site %in% csn.sites$site[which(csn.sites$longitude > -100)])
pm10.rural.east <- subset(pm10.mean,site %in% imp.sites$site[which(imp.sites$longitude > -100)])
pm10.urban.west <- subset(pm10.mean,site %in% csn.sites$site[which(csn.sites$longitude < -100)])
pm10.rural.west <- subset(pm10.mean,site %in% imp.sites$site[which(imp.sites$longitude < -100)])
pm25.urban.east <- subset(pm25.mean,site %in% csn.sites$site[which(csn.sites$longitude > -100)])
pm25.rural.east <- subset(pm25.mean,site %in% imp.sites$site[which(imp.sites$longitude > -100)])
pm25.urban.west <- subset(pm25.mean,site %in% csn.sites$site[which(csn.sites$longitude < -100)])
pm25.rural.west <- subset(pm25.mean,site %in% imp.sites$site[which(imp.sites$longitude < -100)])
pm25.nroad <- subset(pm25.mean,site %in% nroad.sites$site)

pm.table3 <- data.frame(pollutant=c(rep("PM10",5),rep("PM2.5",6)),rbind(
  get.stats(df=pm10.mean,metric="DA24",region="all",season="all",digits=0),
  get.stats(df=pm10.urban.east,metric="DA24",region="all",season="all",digits=0),
  get.stats(df=pm10.rural.east,metric="DA24",region="all",season="all",digits=0),
  get.stats(df=pm10.urban.west,metric="DA24",region="all",season="all",digits=0),
  get.stats(df=pm10.rural.west,metric="DA24",region="all",season="all",digits=0),
  get.stats(df=pm25.mean,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=pm25.urban.east,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=pm25.rural.east,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=pm25.urban.west,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=pm25.rural.west,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=pm25.nroad,metric="DA24",region="all",season="all",digits=1)))
...
csn.sites <- subset(subset(pm25.spec.monitors,grepl("CSN",network)),!duplicated(site))
imp.sites <- subset(subset(pm25.spec.monitors,grepl("IMPROVE",network)),!duplicated(site))
urban.east <- subset(pm25.spec,site %in% csn.sites$site[which(csn.sites$longitude > -100)])
rural.east <- subset(pm25.spec,site %in% imp.sites$site[which(imp.sites$longitude > -100)])
urban.west <- subset(pm25.spec,site %in% csn.sites$site[which(csn.sites$longitude < -100)])
rural.west <- subset(pm25.spec,site %in% imp.sites$site[which(imp.sites$longitude < -100)])

pm.table6 <- rbind(
  get.stats(df=pm25.spec,metric="SO4",region="all",season="all",digits=2),
  get.stats(df=urban.east,metric="SO4",region="all",season="1st quarter",digits=2),
  get.stats(df=rural.east,metric="SO4",region="all",season="2nd quarter",digits=2),
  get.stats(df=urban.west,metric="SO4",region="all",season="3rd quarter",digits=2),
  get.stats(df=rural.west,metric="SO4",region="all",season="4th quarter",digits=2),
  get.stats(df=pm25.spec,metric="NO3",region="all",season="all",digits=2),
  get.stats(df=urban.east,metric="NO3",region="all",season="1st quarter",digits=2),
  get.stats(df=rural.east,metric="NO3",region="all",season="2nd quarter",digits=2),
  get.stats(df=urban.west,metric="NO3",region="all",season="3rd quarter",digits=2),
  get.stats(df=rural.west,metric="NO3",region="all",season="4th quarter",digits=2),
  get.stats(df=pm25.spec,metric="EC",region="all",season="all",digits=2),
  get.stats(df=urban.east,metric="EC",region="all",season="1st quarter",digits=2),
  get.stats(df=rural.east,metric="EC",region="all",season="2nd quarter",digits=2),
  get.stats(df=urban.west,metric="EC",region="all",season="3rd quarter",digits=2),
  get.stats(df=rural.west,metric="EC",region="all",season="4th quarter",digits=2),
  get.stats(df=pm25.spec,metric="OC",region="all",season="all",digits=2),
  get.stats(df=urban.east,metric="OC",region="all",season="1st quarter",digits=2),
  get.stats(df=rural.east,metric="OC",region="all",season="2nd quarter",digits=2),
  get.stats(df=urban.west,metric="OC",region="all",season="3rd quarter",digits=2),
  get.stats(df=rural.west,metric="OC",region="all",season="4th quarter",digits=2),
  get.stats(df=pm25.spec,metric="Crustal",region="all",season="all",digits=2),
  get.stats(df=urban.east,metric="Crustal",region="all",season="1st quarter",digits=2),
  get.stats(df=rural.east,metric="Crustal",region="all",season="2nd quarter",digits=2),
  get.stats(df=urban.west,metric="Crustal",region="all",season="3rd quarter",digits=2),
  get.stats(df=rural.west,metric="Crustal",region="all",season="4th quarter",digits=2),
  get.stats(df=pm25.spec,metric="Sea_Salt",region="all",season="all",digits=2),
  get.stats(df=urban.east,metric="Sea_Salt",region="all",season="1st quarter",digits=2),
  get.stats(df=rural.east,metric="Sea_Salt",region="all",season="2nd quarter",digits=2),
  get.stats(df=urban.west,metric="Sea_Salt",region="all",season="3rd quarter",digits=2),
  get.stats(df=rural.west,metric="Sea_Salt",region="all",season="4th quarter",digits=2))
...
so2.table2 <- rbind(
  get.stats(df=daily,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=source,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=urban,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=rural,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=volcano,metric="MDA1",region="all",season="all",digits=1),
  get.stats(df=daily,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=source,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=urban,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=rural,metric="DA24",region="all",season="all",digits=1),
  get.stats(df=volcano,metric="DA24",region="all",season="all",digits=1))
