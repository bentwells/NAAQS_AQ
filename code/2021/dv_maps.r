...
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/COdv1hr",curr.year-1,"_",curr.year,".png",sep="")
...
n.sites <- table(cut(vals,breaks=c(0,bins-0.1,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(sprintf("%4.1f",bin.min)," - ",bin.max," ppm (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/COdv8hr",curr.year-1,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/NO2dv1hr",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
n.sites <- table(cut(vals,breaks=c(0,bins-1,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ppb (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/NO2dvAnn",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
n.sites <- table(cut(vals,breaks=c(0,bins-1,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ppb (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/O3dv8hr",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/Pbdv3mo",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM10dv24h",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
n.sites <- table(cut(vals,breaks=c(0,bins-1,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ug/m^3 (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM25dv24h",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM25dvAnn",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
n.sites <- table(cut(vals,breaks=c(0,bins-1,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ppb (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/SO2dv1hr",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
legend.lab <- paste(bin.min," - ",bin.max," ug/m^3 (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM10_25avg",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
...
n.sites <- table(cut(vals,breaks=c(0,bins,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ug/m^3 (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM25_SO4avg",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
add.layer(type="points",x=map.vals$longitude[o],y=map.vals$latitude[o],
...
n.sites <- table(cut(vals,breaks=c(0,bins,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ug/m^3 (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM25_NO3avg",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
add.layer(type="points",x=map.vals$longitude[o],y=map.vals$latitude[o],
...
n.sites <- table(cut(vals,breaks=c(0,bins,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ug/m^3 (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM25_ECavg",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
add.layer(type="points",x=map.vals$longitude[o],y=map.vals$latitude[o],
...
n.sites <- table(cut(vals,breaks=c(0,bins,Inf))); keep <- which(n.sites > 0);
legend.lab <- paste(bin.min," - ",bin.max," ug/m^3 (",n.sites," sites)",sep="")
file.name <- paste("NAAQS_AQ/dv_maps/",curr.year,"/PM25_OCavg",curr.year-2,"_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
layout(mat=matrix(c(1,2),2,1),width=1,height=c(1,0.1))
draw.map("state",proj.args=pa,hires=TRUE,col="gray95")
add.layer(type="points",x=map.vals$longitude[o],y=map.vals$latitude[o],
