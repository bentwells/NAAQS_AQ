...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/CH4_piechart_",(curr.year-1),".png",sep="")
...
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/CH4_trends_2002_",(curr.year-1),".png",sep="")
...
abline(h=seq(5000,35000,5000),v=ch4.years,col="white")
...
file.name <- paste("NAAQS_AQ/emissions_maps/",nei.year,"/CO_county_density_",nei.year,".png",sep="")
...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/CO_piechart_",nei.year,".png",sep="")
png(file=file.name,width=800,height=600)
par(mar=c(0,5,2,5),cex=1.25,cex.main=1.5,bg="gray95")
pie(x=df$emis,labels=pie.labels,main=pie.title,col=pie.colors,radius=0.9)
dev.off()
...
source.labels <- c("Highway Vehicles","Non-Road Mobile","Stationary Fuel Combustion",
  "Industrial and Other Processes","Other Anthropogenic Sources")
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/CO_trends_2002_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
par(mar=c(5,5,1,1),mgp=c(3.5,0.7,0),cex=1.5,las=2)
...
file.name <- paste("NAAQS_AQ/emissions_maps/",nei.year,"/Pb_county_density_",nei.year,".png",sep="")
png(file=file.name,width=1500,height=900)
layout(matrix(c(1,2),2,1),widths=1,heights=c(0.9,0.1))
draw.map("state",proj.args=pa)
for (i in 1:nrow(county.data)) {
...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/Pb_piechart_",nei.year,".png",sep="")
png(file=file.name,width=800,height=600)
par(mar=c(0,5,2,5),cex=1.25,cex.main=1.5,bg="gray95")
pie(x=df$emis,labels=pie.labels,main=pie.title,col=pie.colors,radius=0.9)
dev.off()
...
df <- read.csv(paste("NAAQS_AQ/data/",curr.year,"/Lead_emissions_1990_",trend.year,".csv",sep=""))
...
source.labels <- c("Highway Vehicles","Non-Road Mobile","Stationary Fuel Combustion",
  "Industrial and Other Processes")
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/Pb_trends_1990_",trend.year,".png",sep="")
png(file=file.name,width=1200,height=800)
par(mar=c(5,5,1,1),mgp=c(3.5,0.7,0),cex=1.5,las=2)
...
file.name <- paste("NAAQS_AQ/emissions_maps/",nei.year,"/NOx_county_density_",nei.year,".png",sep="")
png(file=file.name,width=1500,height=900)
layout(matrix(c(1,2),2,1),widths=1,heights=c(0.9,0.1))
draw.map("state",proj.args=pa)
for (i in 1:nrow(county.data)) {
...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/NOx_piechart_",nei.year,".png",sep="")
png(file=file.name,width=800,height=600)
par(mar=c(0,5,2,5),cex=1.25,cex.main=1.5,bg="gray95")
pie(x=df$emis,labels=pie.labels,main=pie.title,col=pie.colors,radius=0.9)
dev.off()
...
source.labels <- c("Highway Vehicles","Non-Road Mobile","Stationary Fuel Combustion",
  "Industrial and Other Processes","Other Anthropogenic Sources")
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/NOx_trends_2002_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
par(mar=c(5,5,1,1),mgp=c(3.5,0.7,0),cex=1.5,las=2)
plot(x=NULL,y=NULL,type='n',axes=FALSE,xaxs='i',xlim=c(2002,curr.year),
...
file.name <- paste("NAAQS_AQ/emissions_maps/",nei.year,"/PM10_county_density_",nei.year,".png",sep="")
png(file=file.name,width=1500,height=900)
layout(matrix(c(1,2),2,1),widths=1,heights=c(0.9,0.1))
draw.map("state",proj.args=pa)
for (i in 1:nrow(county.data)) {
...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/PM10_piechart_",nei.year,".png",sep="")
png(file=file.name,width=800,height=600)
par(mar=c(0,5,2,5),cex=1.25,cex.main=1.5,bg="gray95")
pie(x=df$emis,labels=pie.labels,main=pie.title,col=pie.colors,radius=0.9)
dev.off()
...
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/PM10_trends_2002_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
par(mar=c(5,5,1,1),mgp=c(3.5,0.7,0),cex=1.5,las=2)
plot(x=NULL,y=NULL,type='n',axes=FALSE,xaxs='i',xlim=c(2002,curr.year),
...
file.name <- paste("NAAQS_AQ/emissions_maps/",nei.year,"/PM25_county_density_",nei.year,".png",sep="")
png(file=file.name,width=1500,height=900)
layout(matrix(c(1,2),2,1),widths=1,heights=c(0.9,0.1))
draw.map("state",proj.args=pa)
for (i in 1:nrow(county.data)) {
...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/PM25_piechart_",nei.year,".png",sep="")
png(file=file.name,width=800,height=600)
par(mar=c(0,5,2,5),cex=1.25,cex.main=1.5,bg="gray95")
pie(x=df$emis,labels=pie.labels,main=pie.title,col=pie.colors,radius=0.9)
dev.off()
...
source.labels <- c("Stationary Fuel Combustion","Industrial and Other Processes",
  "Transportation","Other Anthropogenic Sources")
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/PM25_trends_2002_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
par(mar=c(5,5,1,1),mgp=c(3.5,0.7,0),cex=1.5,las=2)
plot(x=NULL,y=NULL,type='n',axes=FALSE,xaxs='i',xlim=c(2002,curr.year),
...
file.name <- paste("NAAQS_AQ/emissions_maps/",nei.year,"/SO2_county_density_",nei.year,".png",sep="")
png(file=file.name,width=1500,height=900)
layout(matrix(c(1,2),2,1),widths=1,heights=c(0.9,0.1))
draw.map("state",proj.args=pa)
for (i in 1:nrow(county.data)) {
...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/SO2_piechart_",nei.year,".png",sep="")
png(file=file.name,width=800,height=600)
par(mar=c(0,5,2,5),cex=1.25,cex.main=1.5,bg="gray95")
pie(x=df$emis,labels=pie.labels,main=pie.title,col=pie.colors,radius=0.9)
dev.off()
...
source.labels <- c("Stationary Fuel Combustion","Industrial and Other Processes",
  "Transportation","Other Anthropogenic Sources")
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/SO2_trends_2002_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
par(mar=c(5,5,1,1),mgp=c(3.5,0.7,0),cex=1.5,las=2)
plot(x=NULL,y=NULL,type='n',axes=FALSE,xaxs='i',xlim=c(2002,curr.year),
...
file.name <- paste("NAAQS_AQ/emissions_maps/",nei.year,"/VOC_county_density_",nei.year,".png",sep="")
png(file=file.name,width=1500,height=900)
layout(matrix(c(1,2),2,1),widths=1,heights=c(0.9,0.1))
draw.map("state",proj.args=pa)
for (i in 1:nrow(county.data)) {
...
file.name <- paste("NAAQS_AQ/emissions_piecharts/",nei.year,"/VOC_piechart_",nei.year,".png",sep="")
png(file=file.name,width=800,height=600)
par(mar=c(0,5,2,5),cex=1.25,cex.main=1.5,bg="gray95")
pie(x=df$emis,labels=pie.labels,main=pie.title,col=pie.colors,radius=0.9)
dev.off()
...
source.labels <- c("Highway Vehicles","Non-Road Mobile","Stationary Fuel Combustion",
  "Industrial and Other Processes","Other Anthropogenic Sources")
file.name <- paste("NAAQS_AQ/emissions_trends/",curr.year,"/VOC_trends_2002_",curr.year,".png",sep="")
png(file=file.name,width=1200,height=800)
par(mar=c(5,5,1,1),mgp=c(3.5,0.7,0),cex=1.5,las=2)
plot(x=NULL,y=NULL,type='n',axes=FALSE,xaxs='i',xlim=c(2002,curr.year),
