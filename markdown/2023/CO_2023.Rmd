...
|      Figure 5 below shows a map of the 8-hour CO design values and Figure 6 shows a map of the 1-hour CO design values at U.S. ambient air monitoring sites based on data from the `r params$curr.year-1`-`r params$curr.year` period. There were two sites in Puerto Rico that exceeded the 8-hour CO NAAQS in 2022-2023. It is unclear what caused these high concentrations. There were no sites that exceeded the 1-hour CO NAAQS in `r params$curr.year-1`-`r params$curr.year`. Nearly all other sites in the U.S. were well below the NAAQS, with design values generally below 3 ppm for the 8-hour CO NAAQS and below 5 ppm for the 1-hour CO NAAQS.
