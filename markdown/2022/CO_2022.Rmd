...
|      Figure 5 below shows a map of the 8-hour CO design values and Figure 6 shows a map of the 1-hour CO design values at U.S. ambient air monitoring sites based on data from the `r params$curr.year-1`-`r params$curr.year` period. There were two sites in Puerto Rico that exceeded the 8-hour CO NAAQS in 2022 and one of those sites also exceeded the 1-hour CO NAAQS. It is unclear what caused these high concentrations. Nearly all other sites in the U.S. were well below the NAAQS, with design values generally below 3 ppm for the 8-hour CO NAAQS and below 5 ppm for the 1-hour CO NAAQS.
...
|      Figure 9 below shows the national trends in the 8-hour and 1-hour CO design values based on the `r nrow(co.site.dvs.8hr)` sites shown in Figure 7 and Figure 8, respectively. The national median of the 8-hour design values has decreased by `r pct.change.8hr`% from about `r round(median.8hr.past,1)` ppm in 2000 to about `r round(median.8hr.curr,1)` ppm in `r params$curr.year`. The national median of the 1-hour design values has decreased by `r pct.change.1hr`% from about `r round(median.1hr.past,1)` ppm in 2000 to about `r round(median.1hr.curr)` ppm in `r params$curr.year`.
