...
for (i in 1:nrow(df2)) { lines(x=seq(1990,trend.year,3),y=df2[i,],col=trend.border[i]) }
...
```{r label="Figure08-national-trend-dvs",fig.height=4,fig.width=6,fig.align="center"}
